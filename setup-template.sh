...
# 2. current_origin matches 'template-spring-boot' and template_origin is empty: current_origin->default_template_origin, ''->default_origin
# 3. current_origin does not match 'template-spring-boot': current_origin->default_origin, ''->default_template_origin

template_project_name="template-spring-boot"
